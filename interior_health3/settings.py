"""
Django settings for interior_health3 project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'interiorhealth3',
        'USER': 'interior_health_user',  # Your new MySQL username
        'PASSWORD': 'Alphafemale1',      # The password you set
